...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(Context context,AttributeSet attrs) {
        ...
        mUnitsLeft = getAttributeStringValue(context,attrs, SETTINGS, "unitsLeft", "");
        String units = getAttributeStringValue(context,attrs, SETTINGS, "units", "");
        mUnitsRight = getAttributeStringValue(context,attrs, SETTINGS, "unitsRight", units);
